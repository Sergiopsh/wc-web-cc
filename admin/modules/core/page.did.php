<?php /* $Id: page.did.php 8590 2010-01-11 22:04:29Z p_lindheimer $ */
...
<?php 
    if ($extdisplay) {	
      ...
      if (is_array($ininfo) && !empty($ininfo)) {
        ...
        $faxemail    = htmlspecialchars($faxemail);
...
<?php } ?>
		...
		<tr>
			...
			<td>
				<input type="text" size="20" name="faxemail" value="<?php echo $faxemail?>" tabindex="<?php echo ++$tabindex;?>"/>
			</td>
		</tr>
		<tr>
