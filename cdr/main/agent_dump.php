...
*/
 ...
 $function_title      = "Agent Dumped Calls";
 $function_title_long = "Agent Dumped Calls by Agent";
 $function_key_th     = "Agent / Date";
 $function_val_th     = $function_title;
 $sql = "SELECT * FROM queuelog where action='AGENTDUMP' order by timestamp,agent";
