...
*/
 ...
 $function_title      = "Caller Calls Completed";
 $function_title_long = "Calls Completed by Caller";
 $function_key_th     = "Date";
 $function_val_th     = $function_title;
 $sql = "SELECT * FROM queuelog where action='COMPLETECALLER' order by timestamp";
