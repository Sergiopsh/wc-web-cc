...
*/
 ...
 $function_title      = "Agent Calls Completed";
 $function_title_long = "Calls Completed by Agent";
 $function_key_th     = "Agent / Date";
 $function_val_th     = $function_title;
 $sql = "SELECT * FROM queuelog where action='COMPLETEAGENT' order by timestamp,agent";
