...
*/
 ...
 $function_title      = "Agent Call Back Logins";
 $function_title_long = "Agent Call Back Logins by Agent";
 $function_key_th     = "Agent / Date";
 $function_val_th     = $function_title;
 $sql = "SELECT * FROM queuelog where action='AGENTCALLBACKLOGIN' order by timestamp,agent";
