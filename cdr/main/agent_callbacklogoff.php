...
*/
 ...
 $function_title      = "Agent Call Back Logoffs";
 $function_title_long = "Agent Call Back Logoffs by Agent";
 $function_key_th     = "Agent / Date";
 $function_val_th     = $function_title;
 $sql = "SELECT * FROM queuelog where action='AGENTCALLBACKLOGOFF' order by timestamp,agent";
