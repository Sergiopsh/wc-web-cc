<?php
$registered_modules=array("Home","Employees","Operators","TariffPlans","Reports","Recording","Administration","VirtualFax","iFrames","Departments","AstDB","MySettings","System","ConfigFiles","CodesDirectory","FileManager","Rates","Roles","Modules","Currencies","Users","AstMonitor","ReportsOper","ReportsSuper");
...
$main_menu=array(array(array("Home","images/home.gif"),$strHome,"javascript:loadModule(0,'Home','Home','');"),
		 ...
		 array(array("ReportsOper","images/reports.gif"),$strReportsOper,"javascript:loadModule(0,'ReportsOper','ReportsOper','CommonReports');"),
