...
$list_tasks = $db->get_cond_list(array("task_id","phone_number","path","date_first_try","try_number","date_end","call_length","call_status","processed_by","call_end-call_start"),"autocall.calls","","call_end-call_start,call_status desc",$current_page,$limit_display);
