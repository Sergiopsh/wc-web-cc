...
$list_users = $db->get_cond_list("","autocall.abon_phone_with_summ","","phone_number,summ",$current_page,$limit_display);
...
$cn=3;
$tbl->tblHead(array($cn,"","",""),array("Номер телефона","Сумма"));
    ...
    for($j=0; $j < $num_disp; $j++) {
	  ...
	  $tbl->td($list_users[$j][1],"20%","left","",$list_users[$j][0],"","");
	  $tbl->td($list_users[$j][2],"20%","left","",$list_users[$j][0],"","");
