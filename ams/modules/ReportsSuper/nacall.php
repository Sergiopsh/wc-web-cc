...
<?=$strReports?>: отчёт по неотвеченным звонкам
</div>
<br>
<?
...
rep.sortByDate=function() {
    ...
    loadModule(1,'ReportsSuper','ReportsSuper','NACall',$H({sort_date: sort_date}));
}
...
$p->action="$('module_form').current_page.value=0;loadModule(1,'','ReportsSuper','NACall',\$H({search: 1}));";
$p->align2="right";
