...
$module_menu = array(array($strReports,"images/reports.gif"),
		   array(array($strCommonReport, "javascript:loadModule('','ReportsSuper','ReportsSuper','CommonReport');"),
			 ...
			 array("Неотвеченные звонки", "javascript:loadModule('','ReportsSuper','ReportsSuper','NACall');"),
			 
			 array($strNightReport, "javascript:loadModule('','ReportsSuper','ReportsSuper','NightReport');")
			 //,array("Average Speed of Answer", "javascript:loadModule('','ReportsSuper','ReportsSuper','asa');")
