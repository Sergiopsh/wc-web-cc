...
function setPeriod(z) {
    ...
    var year = d.getFullYear();
    switch (z) {
	case '0': d.setHours(0,0,0,0); periodfrom=d.getTime();
	periodto=d.getTime()+Date.DAY-1000;break;
	case '1': d.setHours(0,0,0,0); periodfrom=d.getTime()-Date.DAY;
	periodto=d.getTime()-1000;break;
	case '2': d.setDate(1); d.setMonth(0); d.setHours(0,0,0,0);
	periodfrom=d.getTime(); periodto=d.getTime()+(31*Date.DAY)-1000; break;
	case '3': d.setDate(1); d.setMonth(1); d.setHours(0,0,0,0);
	periodfrom=d.getTime(); periodto=d.getTime()+(28*Date.DAY)-1000; break;
	case '4': d.setDate(1); d.setMonth(2); d.setHours(0,0,0,0);
	periodfrom=d.getTime(); periodto=d.getTime()+(31*Date.DAY)-1000-Date.HOUR; break;
	case '5': d.setDate(1); d.setMonth(3); d.setHours(0,0,0,0);
	periodfrom=d.getTime(); periodto=d.getTime()+(30*Date.DAY)-1000; break;
	case '6': d.setDate(1); d.setMonth(4); d.setHours(0,0,0,0);
	periodfrom=d.getTime(); periodto=d.getTime()+(31*Date.DAY)-1000; break;
	case '7': d.setDate(1); d.setMonth(5); d.setHours(0,0,0,0);
	periodfrom=d.getTime(); periodto=d.getTime()+(30*Date.DAY)-1000; break;
	case '8': d.setDate(1); d.setMonth(6); d.setHours(0,0,0,0);
	periodfrom=d.getTime(); periodto=d.getTime()+(31*Date.DAY)-1000; break;
	case '9': d.setDate(1); d.setMonth(7); d.setHours(0,0,0,0);
	periodfrom=d.getTime(); periodto=d.getTime()+(31*Date.DAY)-1000; break;
	case '10': d.setDate(1); d.setMonth(8); d.setHours(0,0,0,0);
	periodfrom=d.getTime(); periodto=d.getTime()+(30*Date.DAY)-1000; break;
	case '11': d.setDate(1); d.setMonth(9); d.setHours(0,0,0,0);
	periodfrom=d.getTime(); periodto=d.getTime()+(31*Date.DAY)-1000+Date.HOUR; break;
	case '12': d.setDate(1); d.setMonth(10); d.setHours(0,0,0,0);
	periodfrom=d.getTime(); periodto=d.getTime()+(30*Date.DAY)-1000; break;
	case '13': d.setDate(1); d.setMonth(11); d.setHours(0,0,0,0);
	periodfrom=d.getTime(); periodto=d.getTime()+(31*Date.DAY)-1000; break;
	default: periodfrom-=3*Date.HOUR; break;
    }
    var dt= new Array;
