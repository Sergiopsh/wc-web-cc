...
$tbl->tblHead(array($cn,"13","14","8","","","8","9"),array($dh,$strRecordFileName,$strKByte,$strSource,$strDestination,$strDur,$strDirection));
	...
	<td nowrap><?=$list_records[$j][0]?></td>
	<td nowrap><a href="javascript:rec.listenRecord('<?=$list_records[$j][1]?>')" title="<?=$strListenRecord?>"><?=$f?>.wav</a></td>
...
<?
$tbl->addSelOper($strDeleteSelected,"rec.deleteSelected()","drop.gif");
