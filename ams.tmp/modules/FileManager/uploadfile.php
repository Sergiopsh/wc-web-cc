...
if($type == 'remote') {
 ...
 if(!file_exists($local_file)) 
    echo "fm.showMessage('$strErrorUploadFile',0,'warning.gif');";
...
$file=$_FILES['upload_local_file']['tmp_name'];
  if(!file_exists($file)) {
    echo "<script type='text/javascript'>parent.fm.showMessage('$strErrorUploadFile',0,'warning.gif');</script></body></html>";
    exit();
  }
  ...
  if(!$res) echo "parent.fm.showMessage('$strErrorUploadFile : ".addslashes($full_file_name)."',0,'warning.gif');";
