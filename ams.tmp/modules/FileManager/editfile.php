...
//editor.menu = new _Toolbar('editor-menu',{className: 'menu-panel',cellBg: '#9fb2e3', panelBg: '#cdd7f0', imgdir: 'images'});
editor.menu = new _Toolbar('editor-menu',{className: 'menu-panel', panelBg: '#d9d9d9', imgdir: 'images'});
//editor.menu = new _Toolbar('editor-menu',{className: 'menu-panel',imgdir: 'images'});
